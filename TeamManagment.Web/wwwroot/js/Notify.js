...
function createNotificationItem(notify) {
    var div = document.createElement("div");
	div.className = "d-flex flex-stack py-4";
	var date1 = new Date(notify.sendAt); // Replace with your date
	var date2 = new Date(); // Current date and time
    ...
    var innerHTML = `
        ...
        <div class="d-flex align-items-center">
			...
			<div class="mb-0 me-2">
				<a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bold">${notify.title}</a>
				<div class="text-gray-400 fs-7">${notify.message}</div>
			</div>
		</div>
		<span class="badge badge-light fs-8">${hours}:${minutes} ago</span>`;
